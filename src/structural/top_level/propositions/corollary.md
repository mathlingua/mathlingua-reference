...
`Corollary:` is a theorem-like top-level item. It may have an optional command heading and optional prose text on the `Corollary:` section.
...
`Corollary:` additionally requires an `of:` section that records what it follows from.
